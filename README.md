...
![Uploading ads](ad-feedback/Screenshots/logging-responses-to-each-of-three-ads.PNG)

The ad is shown, and viewers' emotions are displayed in real-time.
![Real-time emotion detection](ad-feedback/Screenshots/logging-responses-to-each-of-three-ads.PNG)
...
![Logging responses](ad-feedback/Screenshots/logging-responses-to-each-of-three-ads.PNG)
